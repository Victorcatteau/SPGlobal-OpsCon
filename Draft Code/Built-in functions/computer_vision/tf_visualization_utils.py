# ==============================================================================
# COPY OF THE TENSORFLOW ORIGINAL FILE by Théo ALVES DA COSTA
#
...
def visualize_boxes_and_labels_on_image_array(image,
  ...
  for i in range(min(max_boxes_to_draw, boxes.shape[0])):
    if scores is None or scores[i] > min_score_thresh or (force_cat is not None and classes[i] in force_cat and scores[i] > 0.05):
