...
"""--------------------------------------------------------------------
VIS FROM NEO4J DATABASE

Copied from the git https://github.com/nicolewhite/neo4j-jupyter
...
def vis_network(nodes, edges, physics=False):
    ...
    <html>
    <head>
      <script type="text/javascript" src="C:/git/oddo-ai/1. Notebooks/Module 1/lib/vis/dist/vis.js"></script>
      <link href="C:/git/oddo-ai/1. Notebooks/Module 1/lib/vis/dist/vis.css" rel="stylesheet" type="text/css">
    </head>
    <body>
